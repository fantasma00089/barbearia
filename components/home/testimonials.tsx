...
export function Testimonials({ testimonials }: { testimonials: SiteSettings["content"]["testimonials"] }) {
      ...
      <div className="container">
        ...
        <Stagger as="ul" className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((t, i) => (
            <StaggerItem as="li" key={`${t.name}-${i}`} className="card-interactive flex flex-col p-6">
