/** Ícones de marca desenhados localmente (lucide não inclui logos de marcas). */
...
/** Navalha — ícone de "Barba" no estilo lucide (stroke 2). */
export function RazorIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M3 17 14 6l4 1 3-3" />
      <path d="M14 6c1.5 2.5 1.5 5 0 7.5L9 18" />
      <path d="m3 17 2.5 2.5L9 18" />
    </svg>
  );
}
