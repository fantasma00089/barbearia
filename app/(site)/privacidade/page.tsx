...
export const metadata = buildMetadata({
  ...
  description: `Como a ${siteConfig.shortName} coleta, usa e protege seus dados pessoais no agendamento online, conforme a LGPD.`,
  path: "/privacidade",
});
...
const sections: LegalSection[] = [
  {
    ...
    content: (
      <p>
        O controlador dos dados é <strong>{legal.companyName}</strong> (CNPJ {legal.cnpj}), {fullAddress}. Contato do encarregado
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        {contact.whatsappDisplay}, de acordo com nosso horário de atendimento (fuso {businessConfig.timezone}).
      </p>
    ),
  },
];
